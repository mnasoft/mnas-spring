      ...
      (let ((frame (make-instance 'gtk-frame
            ...
            (alignment (make-instance 'gtk-alignment
                                      ...
                                      :xscale 0.80
                                      :yscale 0.25)))
        (gtk-alignment-set-padding alignment 10 30 6 6)
...
(defun example-alignment ()
  (within-main-loop
    (let ((window (make-instance 'gtk-window :type :toplevel :title "Example Alignment" :border-width 12 :width-request 300 :height-request 300))
          (grid   (make-instance 'gtk-grid   :column-spacing 12 :column-homogeneous t :row-spacing 12 :row-homogeneous t)))
...
;;;; (mnas-spring/gtk::example-alignment)
