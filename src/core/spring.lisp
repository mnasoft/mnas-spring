...
(defclass <spring> ()
  ...
  (:documentation "@b(Описание:) класс @b(<spring>) представляет винтовую пружину сжатия из проволоки круглого сечения.
...
(defmethod <spring>-taui-fi ((spr <spring>) fi)
  "@b(Описание:) метод @b(<spring>-taui-fi) возвращает напряжение при
   кручении при приложении к пружине силы fi.
